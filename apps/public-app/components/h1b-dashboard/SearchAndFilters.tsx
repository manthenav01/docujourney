            ...
            {enableSemanticSearch ? (
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-12 h-14 text-base border-border focus:border-primary focus:ring-2 focus:ring-primary/20 rounded-xl bg-muted/50 transition-all duration-200"
                />
              </div>
            )}
          </div>
          ...
          {showSearchInstructions && (
            <div className="mt-4 bg-primary/10 rounded-lg p-4 border border-primary/20">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-sm font-medium text-primary mb-1">Search for Companies & Jobs</h4>
