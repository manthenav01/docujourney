...
module.exports = [
  ...
  {
    ignores: [
      // '**/' prefixes matter: `npm run lint` runs eslint per workspace, so a
      // bare '.next/**' resolves against the repo root and misses
      // apps/*/.next — which meant linting the build output.
      '**/node_modules/**',
      '**/.next/**',
      '**/out/**',
      '**/dist/**',
      ...
      'public/**',
      'scripts/data/**',
      // Generated by apps/public-app/scripts/build-slug-filter.mjs: ~500 KB of
      // base64 on one line, which linting has nothing useful to say about.
      '**/lib/slug-filter/data.ts',
      '.venv/**',
      '*.py',
